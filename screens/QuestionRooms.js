      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
        <OptionButton
          ...
          onPress={() => {
            ...
            this.props.navigation.navigate('Chat Screen', {chatRoomName: 'messages1'})}}
        />
        <OptionButton
          icon="ios-chatboxes"
          ...
          this.props.navigation.navigate('Chat Screen', {chatRoomName: 'messages2'})}}
        />
        <OptionButton
          icon="ios-chatboxes"
          ...
          this.props.navigation.navigate('Chat Screen', {chatRoomName: 'messages3'})}}
        />
        <OptionButton
          icon="ios-chatboxes"
          ...
          this.props.navigation.navigate('Chat Screen', {chatRoomName: 'messages4'})}}
        />
        <OptionButton
          icon="ios-chatboxes"
          ...
          this.props.navigation.navigate('Chat Screen', {chatRoomName: 'messages5'})}}
        />
        <OptionButton
          icon="ios-chatboxes"
          ...
          onPress={() => {
            Analytics.logEvent('QuestionSix', {
              screen: 'QuestionRooms',
              purpose: 'User clicks on "Question 6 Chat Room"',
            });
          this.props.navigation.navigate('Chat Screen', {chatRoomName: 'messages6'})}}
          isLastOption
        />
